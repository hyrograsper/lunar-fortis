...
class V1TransactionsCcSaleWalletRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcSaleWalletRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSaleWalletRequest object.
     */
