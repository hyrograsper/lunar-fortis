...
class V1TransactionsCcBalanceInquiryTicketRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcBalanceInquiryTicketRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcBalanceInquiryTicketRequest object.
     */
