 ...
 */
class RejectedTransaction implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the RejectedTransaction object to a human-readable string representation.
     *
     * @return string The string representation of the RejectedTransaction object.
     */
