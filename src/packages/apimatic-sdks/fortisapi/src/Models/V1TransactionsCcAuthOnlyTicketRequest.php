...
class V1TransactionsCcAuthOnlyTicketRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAuthOnlyTicketRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAuthOnlyTicketRequest object.
     */
