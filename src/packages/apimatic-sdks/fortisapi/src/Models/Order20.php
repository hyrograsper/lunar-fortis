...
class Order20 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the Order20 object to a human-readable string representation.
     *
     * @return string The string representation of the Order20 object.
     */
