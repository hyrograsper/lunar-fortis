...
class V1TransactionsCcForceTokenRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcForceTokenRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcForceTokenRequest object.
     */
