...
class V1TransactionsCcForceWalletRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcForceWalletRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcForceWalletRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'walletKeyId' => $this->getWalletKeyId(),
