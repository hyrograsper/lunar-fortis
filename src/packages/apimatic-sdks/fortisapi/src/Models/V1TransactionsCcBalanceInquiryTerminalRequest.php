...
class V1TransactionsCcBalanceInquiryTerminalRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcBalanceInquiryTerminalRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcBalanceInquiryTerminalRequest object.
     */
