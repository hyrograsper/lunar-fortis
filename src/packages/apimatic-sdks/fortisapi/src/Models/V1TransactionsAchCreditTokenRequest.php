...
class V1TransactionsAchCreditTokenRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsAchCreditTokenRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsAchCreditTokenRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'accountVaultApiId' => $this->accountVaultApiId,
                'tokenApiId' => $this->tokenApiId,
                'joi' => $this->joi,
