...
class CcProductTransaction implements \JsonSerializable
{
    ...
    /**
     * Converts the CcProductTransaction object to a human-readable string representation.
     *
     * @return string The string representation of the CcProductTransaction object.
     */
