...
class V1TransactionsCcAvsOnlyTicketRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAvsOnlyTicketRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAvsOnlyTicketRequest object.
     */
