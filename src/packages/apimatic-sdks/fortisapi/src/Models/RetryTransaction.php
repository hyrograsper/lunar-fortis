 ...
 */
class RetryTransaction implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the RetryTransaction object to a human-readable string representation.
     *
     * @return string The string representation of the RetryTransaction object.
     */
