...
class V1TransactionsTipAdjustRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsTipAdjustRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsTipAdjustRequest object.
     */
