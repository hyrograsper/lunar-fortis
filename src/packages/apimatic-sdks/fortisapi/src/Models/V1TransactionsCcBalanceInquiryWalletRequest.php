...
class V1TransactionsCcBalanceInquiryWalletRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcBalanceInquiryWalletRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcBalanceInquiryWalletRequest object.
     */
