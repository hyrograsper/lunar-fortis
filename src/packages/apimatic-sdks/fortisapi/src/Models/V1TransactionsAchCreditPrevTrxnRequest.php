...
class V1TransactionsAchCreditPrevTrxnRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsAchCreditPrevTrxnRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsAchCreditPrevTrxnRequest object.
     */
