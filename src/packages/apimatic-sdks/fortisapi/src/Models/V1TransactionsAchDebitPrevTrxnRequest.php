...
class V1TransactionsAchDebitPrevTrxnRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsAchDebitPrevTrxnRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsAchDebitPrevTrxnRequest object.
     */
