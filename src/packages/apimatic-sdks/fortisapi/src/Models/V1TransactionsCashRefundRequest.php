...
class V1TransactionsCashRefundRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCashRefundRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCashRefundRequest object.
     */
