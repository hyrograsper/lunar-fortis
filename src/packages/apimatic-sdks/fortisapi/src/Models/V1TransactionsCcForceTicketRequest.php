...
class V1TransactionsCcForceTicketRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcForceTicketRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcForceTicketRequest object.
     */
