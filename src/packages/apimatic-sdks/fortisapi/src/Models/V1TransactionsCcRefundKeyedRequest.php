...
class V1TransactionsCcRefundKeyedRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcRefundKeyedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundKeyedRequest object.
     */
