...
class V1TransactionsCcRefundTaptopayRequest implements \JsonSerializable
{
    /**
     ...
     * @var string
     */
    private $cardDataCryptogram;

    /**
     * @var string
     */
    private $generalCardData;

    /**
     * @var string
     */
    private $cardReaderId;
     ...
     */
    public function __construct(string $cardDataCryptogram, string $generalCardData, string $cardReaderId)
    {
    ...
    /**
     * Returns Card Data Cryptogram.
     * Encrypted Cardholder data. Used in Tap to Pay transactions
     */
    public function getCardDataCryptogram(): string
    {
        return $this->cardDataCryptogram;
    }

    /**
     * Sets Card Data Cryptogram.
     * Encrypted Cardholder data. Used in Tap to Pay transactions
     *
     * @required
     * @maps card_data_cryptogram
     */
    public function setCardDataCryptogram(string $cardDataCryptogram): void
    {
        $this->cardDataCryptogram = $cardDataCryptogram;
    }

    /**
     * Returns General Card Data.
     * Plaintext EMV tags. Used in Tap to Pay transactions
     */
    public function getGeneralCardData(): string
    {
        return $this->generalCardData;
    }

    /**
     * Sets General Card Data.
     * Plaintext EMV tags. Used in Tap to Pay transactions
     *
     * @required
     * @maps general_card_data
     */
    public function setGeneralCardData(string $generalCardData): void
    {
        $this->generalCardData = $generalCardData;
    }

    /**
     * Returns Card Reader Id.
     * Identifier of card reader used in Tap to Pay transactions.
     */
    public function getCardReaderId(): string
    {
     ...
     * @maps card_reader_id
     */
    public function setCardReaderId(string $cardReaderId): void
    {
        $this->cardReaderId = $cardReaderId;
    }
    ...
    /**
     * Converts the V1TransactionsCcRefundTaptopayRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundTaptopayRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'cardDataCryptogram' => $this->cardDataCryptogram,
                'generalCardData' => $this->generalCardData,
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        $json['card_data_cryptogram']                       = $this->cardDataCryptogram;
        $json['general_card_data']                          = $this->generalCardData;
        $json['card_reader_id']                             = $this->cardReaderId;
