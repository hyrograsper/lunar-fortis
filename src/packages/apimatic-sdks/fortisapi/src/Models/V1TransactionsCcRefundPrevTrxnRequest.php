...
class V1TransactionsCcRefundPrevTrxnRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcRefundPrevTrxnRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundPrevTrxnRequest object.
     */
