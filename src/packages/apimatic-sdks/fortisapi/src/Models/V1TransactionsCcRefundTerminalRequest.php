...
class V1TransactionsCcRefundTerminalRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcRefundTerminalRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundTerminalRequest object.
     */
