 ...
 */
class ReturnFeeTransaction implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the ReturnFeeTransaction object to a human-readable string representation.
     *
     * @return string The string representation of the ReturnFeeTransaction object.
     */
