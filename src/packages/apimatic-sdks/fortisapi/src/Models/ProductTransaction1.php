...
class ProductTransaction1 implements \JsonSerializable
{
    ...
    /**
     * Converts the ProductTransaction1 object to a human-readable string representation.
     *
     * @return string The string representation of the ProductTransaction1 object.
     */
