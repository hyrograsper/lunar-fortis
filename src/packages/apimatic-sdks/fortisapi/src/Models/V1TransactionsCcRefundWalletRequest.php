...
class V1TransactionsCcRefundWalletRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcRefundWalletRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundWalletRequest object.
     */
