...
class V1TransactionsEbtVoucherClearRefundKeyedRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the V1TransactionsEbtVoucherClearRefundKeyedRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsEbtVoucherClearRefundKeyedRequest object.
     */
