...
class V1TransactionsCcSaleTerminalRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcSaleTerminalRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSaleTerminalRequest object.
     */
