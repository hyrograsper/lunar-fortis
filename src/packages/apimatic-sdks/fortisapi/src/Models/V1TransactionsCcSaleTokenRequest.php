...
class V1TransactionsCcSaleTokenRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcSaleTokenRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSaleTokenRequest object.
     */
