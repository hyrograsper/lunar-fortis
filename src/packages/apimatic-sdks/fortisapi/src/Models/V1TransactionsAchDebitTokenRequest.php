...
class V1TransactionsAchDebitTokenRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsAchDebitTokenRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsAchDebitTokenRequest object.
     */
