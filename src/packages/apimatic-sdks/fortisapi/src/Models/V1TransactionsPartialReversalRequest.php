...
class V1TransactionsPartialReversalRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsPartialReversalRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsPartialReversalRequest object.
     */
