...
class V1TransactionsCcSaleTicketRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcSaleTicketRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSaleTicketRequest object.
     */
