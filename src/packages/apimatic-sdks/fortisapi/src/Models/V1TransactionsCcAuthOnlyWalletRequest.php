...
class V1TransactionsCcAuthOnlyWalletRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAuthOnlyWalletRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAuthOnlyWalletRequest object.
     */
