...
class V1TransactionsCcAvsOnlyPrevTrxnRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAvsOnlyPrevTrxnRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAvsOnlyPrevTrxnRequest object.
     */
