...
class V1TransactionsCcAvsOnlyTokenRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAvsOnlyTokenRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAvsOnlyTokenRequest object.
     */
