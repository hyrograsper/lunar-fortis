...
class Field27Enum
{
    ...
    public const HOME_PHONE_COUNTRY_CODE = 'home_phone_country_code';

    public const OFFICE_PHONE_COUNTRY_CODE = 'office_phone_country_code';

    public const CELL_PHONE_COUNTRY_CODE = 'cell_phone_country_code';
