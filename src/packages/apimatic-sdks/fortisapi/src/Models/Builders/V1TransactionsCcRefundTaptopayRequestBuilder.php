...
/**
 * Builder for model V1TransactionsCcRefundTaptopayRequest
 *
 * @see V1TransactionsCcRefundTaptopayRequest
 */
class V1TransactionsCcRefundTaptopayRequestBuilder
{
    /**
     * @var V1TransactionsCcRefundTaptopayRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcRefundTaptopayRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Transactions Cc Refund Taptopay Request Builder object.
     *
    ...
    {
        return new self(
            new V1TransactionsCcRefundTaptopayRequest($cardDataCryptogram, $generalCardData, $cardReaderId)
        );
    }
    ...
    /**
     * Initializes a new V1 Transactions Cc Refund Taptopay Request object.
     */
    public function build(): V1TransactionsCcRefundTaptopayRequest
    {
