...
/**
 * Builder for model ReturnFeeTransaction
 *
 * @see ReturnFeeTransaction
 */
class ReturnFeeTransactionBuilder
{
    /**
     * @var ReturnFeeTransaction
     */
    private $instance;

    private function __construct(ReturnFeeTransaction $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Return Fee Transaction Builder object.
     */
    public static function init(): self
    {
        return new self(new ReturnFeeTransaction());
    }
    ...
    /**
     * Initializes a new Return Fee Transaction object.
     */
    public function build(): ReturnFeeTransaction
    {
