...
/**
 * Builder for model V1TransactionsCcSaleTaptopayRequest
 *
 * @see V1TransactionsCcSaleTaptopayRequest
 */
class V1TransactionsCcSaleTaptopayRequestBuilder
{
    /**
     * @var V1TransactionsCcSaleTaptopayRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcSaleTaptopayRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Transactions Cc Sale Taptopay Request Builder object.
     *
    ...
    {
        return new self(
            new V1TransactionsCcSaleTaptopayRequest($cardDataCryptogram, $generalCardData, $cardReaderId)
        );
    }
    ...
    /**
     * Initializes a new V1 Transactions Cc Sale Taptopay Request object.
     */
    public function build(): V1TransactionsCcSaleTaptopayRequest
    {
