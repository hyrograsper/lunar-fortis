...
class V1TransactionsCcForceKeyedRequestBuilder
{
     ...
     * @param string|null $value
     */
    public function transId(?string $value): self
    {
        $this->instance->setTransId($value);
        return $this;
    }

    /**
     * Unsets trans id field.
     */
    public function unsetTransId(): self
    {
        $this->instance->unsetTransId();
        return $this;
    }
