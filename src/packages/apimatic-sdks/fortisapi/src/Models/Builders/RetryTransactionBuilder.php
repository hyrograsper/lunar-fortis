...
/**
 * Builder for model RetryTransaction
 *
 * @see RetryTransaction
 */
class RetryTransactionBuilder
{
    /**
     * @var RetryTransaction
     */
    private $instance;

    private function __construct(RetryTransaction $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Retry Transaction Builder object.
     */
    public static function init(): self
    {
        return new self(new RetryTransaction());
    }
    ...
    /**
     * Initializes a new Retry Transaction object.
     */
    public function build(): RetryTransaction
    {
