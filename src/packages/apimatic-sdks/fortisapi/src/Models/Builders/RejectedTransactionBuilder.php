...
/**
 * Builder for model RejectedTransaction
 *
...
{
    /**
     * @var RejectedTransaction
     */
    private $instance;

    private function __construct(RejectedTransaction $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Rejected Transaction Builder object.
     */
    public static function init(): self
    {
        return new self(new RejectedTransaction());
    }
    ...
    /**
     * Initializes a new Rejected Transaction object.
     */
    public function build(): RejectedTransaction
    {
