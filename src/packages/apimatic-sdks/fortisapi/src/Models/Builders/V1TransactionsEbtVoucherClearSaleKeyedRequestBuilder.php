...
/**
 * Builder for model V1TransactionsEbtVoucherClearSaleKeyedRequest
 *
 * @see V1TransactionsEbtVoucherClearSaleKeyedRequest
 */
class V1TransactionsEbtVoucherClearSaleKeyedRequestBuilder
{
    /**
     * @var V1TransactionsEbtVoucherClearSaleKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsEbtVoucherClearSaleKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Transactions Ebt Voucher Clear Sale Keyed Request Builder object.
     *
    ...
    {
        return new self(new V1TransactionsEbtVoucherClearSaleKeyedRequest($accountNumber, $expDate, $authCode));
    }
    ...
    /**
     * Initializes a new V1 Transactions Ebt Voucher Clear Sale Keyed Request object.
     */
    public function build(): V1TransactionsEbtVoucherClearSaleKeyedRequest
    {
