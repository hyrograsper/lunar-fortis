...
class V1TransactionsAchDebitKeyedRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsAchDebitKeyedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsAchDebitKeyedRequest object.
     */
