...
class V1TransactionsCashSaleRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCashSaleRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCashSaleRequest object.
     */
