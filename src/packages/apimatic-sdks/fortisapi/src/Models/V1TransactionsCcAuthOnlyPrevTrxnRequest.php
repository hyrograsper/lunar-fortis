...
class V1TransactionsCcAuthOnlyPrevTrxnRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAuthOnlyPrevTrxnRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcAuthOnlyPrevTrxnRequest object.
     */
