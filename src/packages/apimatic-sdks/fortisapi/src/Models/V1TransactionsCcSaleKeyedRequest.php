...
class V1TransactionsCcSaleKeyedRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcSaleKeyedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSaleKeyedRequest object.
     */
