...
class V1TransactionsCcAvsOnlyTerminalRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAvsOnlyTerminalRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAvsOnlyTerminalRequest object.
     */
