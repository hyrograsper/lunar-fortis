...
class V1TransactionsCcRefundTokenRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcRefundTokenRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundTokenRequest object.
     */
