...
class V1TransactionsCcBalanceInquiryKeyedRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcBalanceInquiryKeyedRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcBalanceInquiryKeyedRequest object.
     */
