...
class V1TransactionsCcSaleTaptopayRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the V1TransactionsCcSaleTaptopayRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSaleTaptopayRequest object.
     */
