...
class V1TransactionsCcSalePrevTrxnRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcSalePrevTrxnRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSalePrevTrxnRequest object.
     */
