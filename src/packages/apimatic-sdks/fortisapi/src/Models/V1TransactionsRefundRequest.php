...
class V1TransactionsRefundRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsRefundRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsRefundRequest object.
     */
