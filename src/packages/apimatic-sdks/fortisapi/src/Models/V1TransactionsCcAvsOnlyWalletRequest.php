...
class V1TransactionsCcAvsOnlyWalletRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAvsOnlyWalletRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAvsOnlyWalletRequest object.
     */
