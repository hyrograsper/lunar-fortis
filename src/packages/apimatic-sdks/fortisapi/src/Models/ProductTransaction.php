...
class ProductTransaction implements \JsonSerializable
{
    ...
    /**
     * Converts the ProductTransaction object to a human-readable string representation.
     *
     * @return string The string representation of the ProductTransaction object.
     */
