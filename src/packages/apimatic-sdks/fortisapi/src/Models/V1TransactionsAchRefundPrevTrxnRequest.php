...
class V1TransactionsAchRefundPrevTrxnRequest implements \JsonSerializable
{
    ...
    /**
     * @var IdentityVerification27|null
     */
     ...
     */
    public function getIdentityVerification(): ?IdentityVerification27
    {
     ...
     */
    public function setIdentityVerification(?IdentityVerification27 $identityVerification): void
    {
     ...
     *
     * @maps ach_sec_code
     * @factory \FortisAPILib\Models\AchSecCode31Enum::checkValue
     */
     ...
     * @maps _joi
     */
    public function setJoi(?Joi27 $joi): void
    {
        $this->joi = $joi;
    }

    /**
     * Converts the V1TransactionsAchRefundPrevTrxnRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsAchRefundPrevTrxnRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'previousTransactionApiId' => $this->getPreviousTransactionApiId(),
                'joi' => $this->joi,
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->achSecCode)) {
            $json['ach_sec_code']                         = AchSecCode31Enum::checkValue($this->achSecCode['value']);
        }
