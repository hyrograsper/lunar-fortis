...
class V1TransactionsCcAuthOnlyTaptopayRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the V1TransactionsCcAuthOnlyTaptopayRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcAuthOnlyTaptopayRequest object.
     */
