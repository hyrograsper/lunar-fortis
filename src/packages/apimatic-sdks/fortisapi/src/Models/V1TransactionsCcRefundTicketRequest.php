...
class V1TransactionsCcRefundTicketRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcRefundTicketRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundTicketRequest object.
     */
