...
class V1TransactionsAuthCompleteRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsAuthCompleteRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsAuthCompleteRequest object.
     */
