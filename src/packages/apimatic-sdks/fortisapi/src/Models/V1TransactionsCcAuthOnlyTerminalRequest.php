...
class V1TransactionsCcAuthOnlyTerminalRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TransactionsCcAuthOnlyTerminalRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcAuthOnlyTerminalRequest object.
     */
