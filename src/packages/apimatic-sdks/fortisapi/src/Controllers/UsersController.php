...
use FortisAPILib\Models\Expand108Enum;
use FortisAPILib\Models\Field57Enum;
    ...
    public function viewSingleUserRecord(string $userId, ?array $expand = null, ?array $fields = null): ResponseUser
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/users/{user_id}')
            ...
            ->parameters(
                ...
                QueryParam::init('expand', $expand)->serializeBy([Expand108Enum::class, 'checkValue']),
                QueryParam::init('fields', $fields)->serializeBy([Field57Enum::class, 'checkValue'])
            );
