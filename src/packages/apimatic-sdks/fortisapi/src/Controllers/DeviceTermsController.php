...
use FortisAPILib\Models\Field30Enum;
...
class DeviceTermsController extends BaseController
{
    ...
    public function listAllDeviceTermsRelated(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/device-terms')
            ...
            ->parameters(
                ...
                QueryParam::init('fields', $fields)->serializeBy([Field30Enum::class, 'checkValue'])
            );
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createANewDeviceTerm(V1DeviceTermsRequest $body): ResponseTransactionProcessing
    {
