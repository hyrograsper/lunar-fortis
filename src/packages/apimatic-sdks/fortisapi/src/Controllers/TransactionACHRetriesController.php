...
class TransactionACHRetriesController extends BaseController
{
    /**
     * @param string $transactionAchRetryId Transaction ACH Retry ID.
     ...
     *
     * @return ResponseTransactionAchRetry Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function viewSingleTransactionACHRetryRecord(
        ...
        $_reqBuilder = $this->requestBuilder(
            ...
            ->parameters(
                TemplateParam::init('transaction_ach_retry_id', $transactionAchRetryId),
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ResponseTransactionAchRetry::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * @param V1TransactionAchRetriesRequest $body
     * @param string[]|null $expand Most endpoints in the API have a way to retrieve extra data
     *        related to the current record being retrieved. For example, if the API request is
     *        for the accountvaults endpoint, and the end user also needs to know which contact
     *        the token belongs to, this data can be returned in the accountvaults endpoint
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createATransactionACHRetry(
        V1TransactionAchRetriesRequest $body,
        ?array $expand = null
    ): ResponseTransactionAchRetry {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v1/transaction-ach-retries')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(
     ...
     *        >
     * @param Order20[]|null $order Criteria used in query string parameters to order results. Most
     ...
     *        filter the list of fields returned on the response.
     *
     * @return ResponseTransactionAchRetrysCollection Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function listAllTransactionACHRetriesRelated(
        ?Page $page = null,
        ?array $order = null,
        ?array $filterBy = null,
        ?array $expand = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/transaction-ach-retries')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(
        ...
        $_resHandler = $this->responseHandler()
            ->throwErrorOn('401', ErrorType::init('Unauthorized', Response401tokenException::class))
            ->type(ResponseTransactionAchRetrysCollection::class);
