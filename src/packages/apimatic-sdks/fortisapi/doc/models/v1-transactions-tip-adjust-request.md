...
| `tipAmount` | `int` | Required | Optional tip amount. Tip is not supported for lodging and ecommerce merchants. Use only integer numbers, so $10.99 will be 1099.<br><br>**Constraints**: `<= 999999999` | getTipAmount(): int | setTipAmount(int tipAmount): void |
