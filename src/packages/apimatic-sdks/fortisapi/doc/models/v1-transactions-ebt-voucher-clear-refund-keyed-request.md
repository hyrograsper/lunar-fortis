...
| `authCode` | `string` | Required | Required on force transactions and EBT voucher clear sale/refund. Ignored for all other actions.<br><br>**Constraints**: *Maximum Length*: `8` | getAuthCode(): string | setAuthCode(string authCode): void |
