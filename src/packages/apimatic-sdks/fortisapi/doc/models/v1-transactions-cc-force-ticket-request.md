...
| `ticketId` | `string` | Required | Used in Ticket integration<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getTicketId(): string | setTicketId(string ticketId): void |
