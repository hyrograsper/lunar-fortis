...
| `expDate` | `string` | Required | Required for CC. The Expiration Date for the credit card. (MMYY format).<br><br>**Constraints**: *Maximum Length*: `4` | getExpDate(): string | setExpDate(string expDate): void |
| `trackData` | `?string` | Optional | Track Data from a magnetic card swipe.<br><br>**Constraints**: *Maximum Length*: `256` | getTrackData(): ?string | setTrackData(?string trackData): void |
