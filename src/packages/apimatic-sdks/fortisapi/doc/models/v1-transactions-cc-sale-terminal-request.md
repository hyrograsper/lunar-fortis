...
| `terminalApiId` | `?string` | Optional | Advance Deposit<br><br>**Constraints**: *Maximum Length*: `36` | getTerminalApiId(): ?string | setTerminalApiId(?string terminalApiId): void |
...
| `eSerialNumber` | `?string` | Optional | Encrypted Track Data KSN<br><br>**Constraints**: *Maximum Length*: `20` | getESerialNumber(): ?string | setESerialNumber(?string eSerialNumber): void |
