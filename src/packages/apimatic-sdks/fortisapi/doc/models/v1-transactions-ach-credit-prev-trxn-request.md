...
| `identityVerification` | [`?IdentityVerification27`](../../doc/models/identity-verification-27.md) | Optional | Identity Verification | getIdentityVerification(): ?IdentityVerification27 | setIdentityVerification(?IdentityVerification27 identityVerification): void |
...
| `achSecCode` | [`?string(AchSecCode31Enum)`](../../doc/models/ach-sec-code-31-enum.md) | Optional | Required for ACH transactions if account_vault_id is not provided.<br><br>> Only CCD, PPD, TEL, and WEB are supported for FortisAch. | getAchSecCode(): ?string | setAchSecCode(?string achSecCode): void |
