...
| `cardDataCryptogram` | `string` | Required | Encrypted Cardholder data. Used in Tap to Pay transactions | getCardDataCryptogram(): string | setCardDataCryptogram(string cardDataCryptogram): void |
| `generalCardData` | `string` | Required | Plaintext EMV tags. Used in Tap to Pay transactions | getGeneralCardData(): string | setGeneralCardData(string generalCardData): void |
| `cardReaderId` | `string` | Required | Identifier of card reader used in Tap to Pay transactions. | getCardReaderId(): string | setCardReaderId(string cardReaderId): void |
