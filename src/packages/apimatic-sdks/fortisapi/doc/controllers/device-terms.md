...
| `fields` | [`?(string(Field30Enum)[])`](../../doc/models/field-30-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
