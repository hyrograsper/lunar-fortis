...
$result = $transactionsUpdatesController->void(
    $transactionId,
    $body
);
```
...
```php
function void1(string $transactionId, ?array $expand = null): ResponseTransaction
```
...
$result = $transactionsUpdatesController->void1($transactionId);
```
